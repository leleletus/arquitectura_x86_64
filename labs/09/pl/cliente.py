...
if __name__ == '__main__':
    ...
    while True:
        ...
        server_address = ('localhost',5015) #socket con su respectivo ip y puerto a asociar el cliente
        ...
        try:
            ...
            while True:
                try:
                    ...
                    if msg:
                        print(f">>HOLA SOY EL CLIENTE Y LA CANTIDAD DE CARACTERES RECIBIDA POR SERVIDOR ES: {msg}")
                    else:
                        break
